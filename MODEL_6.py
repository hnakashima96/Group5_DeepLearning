DATASET_PATH = r'/content/drive/My Drive/DL/DL/data_oficial.json'
...
if __name__ == '__main__':
    ...
    model = keras.Sequential([
        ...
        keras.layers.Dense(512, activation = 'relu', kernel_initializer='he_normal'), #effective for training the data (faster)
...
history_track = model.fit(inputs_train,targets_train,
            ...
            epochs = 120,
            batch_size=64,
            verbose=0)   #way the NN is trained 
...
plt.savefig('/content/drive/My Drive/DL/DL/MLP_henormal_2.png')
plt.show()
